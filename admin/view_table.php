...
<body>
    ...
    <form method="post" action="dispfood.php">
        <div class="tbl_center">
            <table>
                <tr>
                    <th colspan="6" class="heading">View Table</th>
                    <th><a href="addtable.php" class="icon"><i class="fas fa-plus"></i></a></th>
                </tr>
                <tr class="bg-info"> 
                ...
                $s = mysqli_query($con, "SELECT * FROM addtable");
                while ($row = mysqli_fetch_array($s)) {
                    ?>
                    <tr>
                       
                        <td><?php echo $row['tableno']; ?></td>
                        <td><?php echo $row['tabletype']; ?> Table</td>
                        <td><?php echo $row['price']; ?>/-</td>
                        <td><?php echo $row['detail']; ?></td>
                        <td><?php echo $row['capacity']; ?></td>
                        <td><img src="uploads/<?php echo $row['images']; ?>" width="100" height="100"></td>
                        <td><a href="delete_table.php?a=<?php echo $row['id']; ?>" class="del" onclick="return confirm('Are you sure you want to delete this item?');"> <i class='fa-solid fa-trash'></i></a></td>
                    </tr>
                <?php
                }
                ?> 
