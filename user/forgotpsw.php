...
function sendMail($email,$reset_token)
{
    ...
    try {
       ...
       //Content
        ...
        <a href='http://localhost/php/hotel/user/updatepassword.php?email=$email&reset_token=$reset_token'>Reset Password ! </a>";
...
<form action="" method="post">
  ...
  <tr align="right">	
		     <td> <img src="../Login.png" style="width: 30%"> <br>
		      <a href=""> Password ?</a></td>
		 </tr>
         <tr>
           <td> Enter your Email</td>
            <td> <input type="mail" name="email" placeholder="Enter Your Email" style="padding: 10px; width: 150%"> <br>   </td>
		</tr>
		
		<tr align="right">	    
        <td align="right"> <br><input type="submit" name="send-reset-link" value="Reset Now" style="color: ; background-color: lightgreen; font-size: 1.5em; font-family: times new roman;"> </td> 
        </tr>
